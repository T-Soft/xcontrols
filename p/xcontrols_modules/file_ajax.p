...
#===================================================================================================CREATE FILE
@xcreate_file_ajax[hData][]	
	<td class="align_right">${hData.label}</td>
	<td>
		<div class="xcontrols-dialog-form" id="${hData.id}_form" title="Загрузить файл">
			<form>
				<fieldset>
		...
		<input type="button" class="btn_load_file" value="Загрузить файл" id="${hData.id}_btn"/>
	</td>
...
#===================================================================================================CREATE FILE FIELD
@create_file_field[hData][reStored_filename;sStored_filename;sOrig_filename;fFilename;f;sFile_path;sFilename;sAccept_ext;f;sMaxSize;iMaxSize]
